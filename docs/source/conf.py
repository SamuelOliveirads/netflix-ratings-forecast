...
# netflix_ratings_forecast documentation build
...
from netflix_ratings_forecast import __version__ as release

# -- Project information -----------------------------------------------------

project = "netflix_ratings_forecast"
author = "Kedro"
...
htmlhelp_basename = "netflix_ratings_forecastdoc"
...
latex_documents = [
    (
        master_doc,
        "netflix_ratings_forecast.tex",
        "netflix_ratings_forecast Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "netflix_ratings_forecast",
        "Project netflix_ratings_forecast codebase.",
        "Nearest-Neighbour",
    )
]
